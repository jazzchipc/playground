        ...
        with tqdm(total=num_episodes) as pbar:
            ...
            while True:
                ...
                while True:
                    ...
                    valid_actions=my_action_prune.get_filtered_actions(self.environment.unaltered_state)

                    if not action in valid_actions:
                        action = min(valid_actions)
                        # be consistent about what action replaces the invalid actions
                        # always choose action with lowest value
